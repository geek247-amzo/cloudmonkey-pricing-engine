...
export const intelligenceCompetitorRelations = relations(intelligenceCompetitor, ({ one, many }) => ({
...
export const intelligenceKeywordRankingRelations = relations(intelligenceKeywordRanking, ({ one }) => ({
	project: one(intelligenceProject, {
...
export const intelligenceRecommendationRelations = relations(intelligenceRecommendation, ({ one }) => ({
	project: one(intelligenceProject, {
...
export const intelligenceScheduledReportRelations = relations(intelligenceScheduledReport, ({ one }) => ({
	project: one(intelligenceProject, {
